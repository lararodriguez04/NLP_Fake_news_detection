...
AUGMENT_TARGETS = {
    "false": 5078,   # ~1566 new samples needed  (2.1x total)
    "mixture":  5078,   # ~1566 new samples needed  (2.1x total)
    "unproven": 5078,   # ~909 new samples needed   (4.1x total)
}
...
def main():
    ...
    # Save
    combined_df.to_csv("/home/lnlpG08/nlp/DATA/train_augmented_data_train.csv", index=False)
