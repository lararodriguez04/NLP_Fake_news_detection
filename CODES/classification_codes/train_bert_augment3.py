...
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/bert/"
...
# 1. CARGAR DATOS DESDE LOS CSV LOCALES
...
# Elimino filas con claim o main_text nulos porque no puedo tokenizarlas
...
def tokenize(examples):
    # Concatenar claim + main_text como par de textos separados por [SEP]
    return tokenizer(
        examples["claim"],
        examples["main_text"],
        truncation=True,
...
# 5. MÉTRICAS — uso Macro-F1 como métrica principal
...
# 10. GUARDAR RESULTADOS CON PROBABILIDADES (para el threshold)
