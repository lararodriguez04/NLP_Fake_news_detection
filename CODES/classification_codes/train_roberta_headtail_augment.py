# RoBERTa con head+tail y data augmentation de sinónimos via BERT fill-mask
# Se augmentan false, mixture y unproven hasta 5078 ejemplos cada uno
# Se cambia el 15% de las palabras del main_text por sinónimos en contexto
...
MODEL_SHORT = "roberta_headtail_augment"
EPOCHS = 3
BATCH_SIZE = 16
MAX_LENGTH = 512
AUGMENT_RATIO = 0.15
...
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/roberta_headtail_augment"
