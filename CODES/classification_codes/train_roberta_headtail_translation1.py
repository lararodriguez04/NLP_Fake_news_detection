...
MODEL_SHORT = "roberta_headtail_translation1"
EPOCHS      = 3
BATCH_SIZE  = 16
MAX_LENGTH  = 512

DATA_PATH    = "/home/lnlpG08/nlp/DATA/"
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/roberta_headtail_translation1"
...
# train_augmented_2.csv tiene "text_1" en lugar de "claim" → renombramos
df_train.rename(columns={"text_1": "claim"}, inplace=True)
...
def tokenize_headtail(examples):
    ...
    for claim, main_text in zip(examples["claim"], examples["main_text"]):
        ...
        # Tokens disponibles para main_text: 512 - claim - 3 tokens especiales (CLS, SEP, SEP)
        ...
        # Construyo: CLS + claim + SEP + main_text_headtail + SEP
        # RoBERTa NO usa token_type_ids, a diferencia de BERT
...
# RoBERTa NO usa token_type_ids → no lo incluimos
