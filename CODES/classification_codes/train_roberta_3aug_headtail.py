...
MODEL_SHORT = "roberta_3aug_headtail"
EPOCHS      = 3
BATCH_SIZE  = 16
MAX_LENGTH  = 512
AUGMENT_RATIO = 0.15
...
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/roberta_3aug_headtail"
...
df_train = pd.read_csv(DATA_PATH + "train_augmented_combined.csv")
...
fill_mask = pipeline("fill-mask", model="roberta-base", device=0)
