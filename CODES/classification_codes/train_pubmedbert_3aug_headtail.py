# BERT con head+tail y combinación de tres tipos de augmentation:
...
MODEL_SHORT = "pubmedbert_3aug_headtail"
EPOCHS      = 3
BATCH_SIZE  = 16
MAX_LENGTH  = 512
AUGMENT_RATIO = 0.15
...
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/pubmedbert_3aug_headtail"
...
def tokenize_headtail(examples):
    ...
    for claim, main_text in zip(examples["claim"], examples["main_text"]):
        ...
        selected = main_tokens if len(main_tokens) <= available else main_tokens[:half] + main_tokens[-half:]
