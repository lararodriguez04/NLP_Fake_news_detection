# Entreno clasificador de fake news sobre el dataset PubHealth usando BiomedBERT
...
MODEL_SHORT = "biomedbert_headtail_sinonimos"
EPOCHS      = 3
BATCH_SIZE  = 16
MAX_LENGTH  = 512
AUGMENT_RATIO = 0.15
...
RESULTS_PATH = "/home/lnlpG08/nlp/CODES/results/biomedbert_headtail_sinonimos/"
...
# 3. DATA AUGMENTATION con BiomedBERT fill-mask

print("\nCargando BiomedBERT fill-mask para augmentation...")
...
# BiomedBERT no tiene token_type_ids, solo input_ids y attention_mask
