# longformer con data augmentation (train_augmented.csv)
...
MODEL_SHORT = "longformer_augment"  
EPOCHS      = 2
BATCH_SIZE  = 2
MAX_LENGTH  = 4096
...
df_train = pd.read_csv(DATA_PATH + "train_augmented.csv")   
...
class_counts = torch.tensor([5078, 3001, 2868, 873], dtype=torch.float)  
...
# GUARDAR RESULTADOS CON PROBABILIDADES
