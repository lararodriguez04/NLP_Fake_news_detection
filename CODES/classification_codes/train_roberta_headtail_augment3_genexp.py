...
# RoBERTa head+tail + augment3 (random swap/deletion) con explicación generada por RAG-BART
# Input: claim + generated_explanation → Output: true / false / mixture / unproven
# Mejor modelo para: UNPROVEN
...
MODEL_SHORT = "roberta_headtail_augment3_genexp"
EPOCHS      = 3
BATCH_SIZE  = 16
MAX_LENGTH  = 512
 
DATA_PATH    = "/home/lnlpG08/nlp/DATA/"
RESULTS_PATH = "/home/lnlpG08/nlp/RESULTS/roberta_headtail_augment3_genexp"
...
print(f"  Input: claim + generated_explanation (RAG-BART) con augment3")
 
# ─────────────────────────────────────────────────────────────────────────────
# CARGAR DATOS
# Train → train_genexp.csv (random swap/deletion + explicaciones generadas)
# Dev   → dev_genexp.csv
# Test  → predictions_rag_bart.csv (ya tiene generated_explanation)
# ─────────────────────────────────────────────────────────────────────────────
