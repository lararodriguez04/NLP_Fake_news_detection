...
SCRIPT="/home/lnlpG08/nlp/AGENT_SUMMARIZATION.py"
LOG="/home/lnlpG08/nlp/output_agent.log"
CHECKPOINT_DIR="/home/lnlpG08/nlp/RESULTS/agent_explanation/agent_model"

while true; do
    echo "Launching Agent training..." >> $LOG
